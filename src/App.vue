<template>
  <div id="app">
    <NavBar
      v-on:search-events="searchEvents"
      v-bind:favorites="favorites"
      v-on:clear-results="clearResults"
      v-on:search-by-date="searchByDate"
    />
    <EventsContainer
...
export default {
  ...
  methods: {
    ...
    searchEvents(keyword) {
      ...
      axios
        .get(
          `https://cors-anywhere.herokuapp.com/https://fierce-earth-48309.herokuapp.com/api/v1/resources/event_keyword?keyword=${keyword}`
        )
    ...
    searchByDate(selectedDate) {
      ...
      axios
        .get(
          `https://cors-anywhere.herokuapp.com/https://fierce-earth-48309.herokuapp.com/api/v1/resources/events/when?date=${monthDate},`
        )
        .then((res) => (this.results = res.data))
        .catch((err) => this.handleError(err));
    },
  ...
  created() {
    axios
      .get(
        "https://cors-anywhere.herokuapp.com/https://fierce-earth-48309.herokuapp.com/api/v1/resources/events/all"
      )
